...
<head>
    ...
    <title>Speed Techserve | Welcome Job Alerts</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <div class="job-alerts-item">
                            <h3 class="medium-title">Job Alerts</h3>
                            ...
                            <div class="alerts-content">
                                <div class="row">
                                    <div class="col-md-3">
                                        <p>{{ $data->job_title }}</p>
                                        <span class="location"><i class="ti-location-pin"></i>{{ $data->location }}</span>
                                    </div>
                                    <div class="col-md-3">
                                        <p>{{ $data->company_name }}</p>
                                    </div>
                                    <div class="col-md-3">
                                        <p><span class="full-time">{{ $data->category }}</span></p>
                                    </div>
                                    <div class="col-md-3">
