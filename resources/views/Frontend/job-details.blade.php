...
<head>
    ...
    <title>Speed Techserve | Welcome Job Details</title>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="header-detail">
                        ...
                        <div class="detail-company pull-right text-right">
                            <div class="img-thum p-2">
                                <img class="img-responsive" src="assets/img/jobs/recent-job-detail.jpg" alt="" style="width: 100px; height:70px;">
                            </div>
                            <div class="name text-capitalize text-justify">
                                <h4>LemonKids LLC</h4>
                                <h5>New York, NY </h5>
                    ...
                    <div class="content-area">
                        <div class="clearfix">
                            <div class="box">
                                ...
                                <a href="/upload-file" class="btn btn-common">Apply for this Job Now</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="job-list">
                                    ...
                                    <div class="job-list-content">
                                        <h4><a href="/job-details">We need a web designer</a><span class="full-time">Full-Time</span></h4>
                                ...
                                <div class="job-list">
                                    ...
                                    <div class="job-list-content">
                                        <h4><a href="/job-details">Software Enginner</a><span class="part-time">Part-Time</span></h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum quaerat aut veniam molestiae atque dolorum omnis temporibus consequuntur saepe. Nemo atque consectetur saepe corporis odit in dicta reprehenderit, officiis, praesentium?</p>
                                        <div class="job-tag">
                                            <div class="pull-left">
                                                <div class="meta-tag">
