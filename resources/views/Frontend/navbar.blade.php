...
<div class="logo-menu">
    <nav class="navbar navbar-default" role="navigation" data-spy="affix" data-offset-top="50">
        <div class="container">
            <div class="navbar-header pb-2">
                ...
                <a class="navbar-brand logo" href="/"><h3 class="medium-title text-capitalize text-justify" style="color: rgb(253, 85, 85);">Speed Techserve</h3></a>
            </div>

            <div class="collapse navbar-collapse" style="font-size: 13px; font-weight:800;" id="navbar">
        ...
        <ul class="wpb-mobile-menu text-capitalize text-justify" style="font-size: 13px; font-weight:800;">
            <li><a class="active" href="/">Home</a></li>
            <li>
    ...
    <div class="navmenu navmenu-default navmenu-fixed-left offcanvas " style="font-size: 13px; font-weight:800;">
