                    ...
                    <div class="col-md-12">
                        <div class="breadcrumb-wrapper">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="current">Add Resumes</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="page-ads">
                            <div class="row box">
                                <div class="divider text-success text-capitalize">
                                    <h1 class="text-center">Hello, Resume Maker</h1>
                                </div>
                                <br>
                                ...
                                <div class="row box">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>First Name <strong class="text-bold text-danger">*</strong></label>
                                            <input type="text" required id="age" name="fname"
                                                placeholder="Enter First Name Here.."  class="form-control @error('fname') is-invalid @enderror">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            <label>Last Name <strong class="text-bold text-danger">*</strong></label>
                                            <input type="text" required id="lname" name="lname"
                                                placeholder="Enter Last Name Here.." class="form-control @error('lname') is-invalid @enderror">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Age <strong class="text-bold text-danger">*</strong></label>
                                        ...
                                        <div class="col-sm-6 form-group">
                                            <label>Gender <strong class="text-bold text-danger">*</strong></label>
                                            <input type="text" required id="gender" name="gender"
                                                placeholder="Enter your gender Here.." class="form-control  @error('age') is-invalid @enderror">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 form-group">
                                            <label>City <strong class="text-bold text-danger">*</strong></label>
                                            <input type="text" required id="city" name="city"
                                                placeholder="Enter City Name Here.." class="form-control  @error('city') is-invalid @enderror">
                                        ...
                                        <div class="col-sm-4 form-group">
                                            <label>State <strong class="text-bold text-danger">*</strong></label>
                                            <input type="text" required id="state" name="state"
                                                placeholder="Enter State Name Here.." class="form-control  @error('state') is-invalid @enderror">
                                        ...
                                        <div class="col-sm-4 form-group">
                                            <label>Zip <strong class="text-bold text-danger">*</strong></label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Phone Number <strong class="text-bold text-danger">*</strong></label>
                                            <input type="text" required id="phone" name="phone"
                                                placeholder="Enter Phone Number Here.." class="form-control  @error('resume') is-invalid @enderror">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            <label>Email Address <strong class="text-bold text-danger">*</strong></label>
                                            <input type="text" required id="email" name="email"
                                                placeholder="Enter Email Address Here.." class="form-control   @error('email') is-invalid @enderror">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Website <strong class="text-bold text-danger">*</strong></label>
                                            <input type="text" required id="web" name="web"
                                                placeholder="Enter Website Name Here.." class="form-control   @error('web') is-invalid @enderror">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            <label>Address <strong class="text-bold text-danger">*</strong></label>
                                            <input type="text" required id="address" name="address" placeholder="Enter your current address Here.." class="form-control  @error('address') is-invalid @enderror">
                                            @error('address')
                                                <span class="invalid-feedback error" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group">
                                        <label>About Your Self <strong class="text-bold text-danger">*</strong></label>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="month" class="form-control" name="ssc_passing_year"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="passing-year">Passing Year :</label>
                                                            <input type="month" class="form-control" name="hsc_passing_year"
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <input type="text" name="grad_exam_type" required id="grad_exam_type" class="form-control">
                                                            </div>

                                                            <div class="form-group col-sm-6">
                                                                <label for="grad_result">Result</label>
                                                                <input type="number" name="grad_result"
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <div class="search-category-container">
                                                                    <label class="styled-select">
                                                                        <select class="dropdown-product selectpicker" name="grad_field" id="grad_field">
                                                            ...
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <input type="month" name="grad_pass_year"
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <input type="text" name="grad_university"
                                                            ...
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <div class="search-category-container">
                                                                    <label class="styled-select">
                                                                        <select name="grad_duration" required id="grad_duration" class="dropdown-product selectpicker">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <input type="text" class="form-control" required id="ms_exam_type" name="ms_exam_type">
                                                            </div>

                                                            <div class="form-group col-sm-6">
                                                                <label for="ms_result">Result</label>
                                                                <input type="number" name="ms_result"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <input type="month" name="ms_pass_year"
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <input type="text" name="ms_university"
                                                            ...
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <div class="search-category-container">
                                                                    <label class="styled-select">
                                                                        <select name="ms_duration" required id="ms_duration" class="dropdown-product selectpicker">
                                ...
                                <div class="row box mt-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <div class="search-category-container">
                                                <label class="styled-select">
                                                    <select class="dropdown-product selectpicker" name="jposition" required id="jposition">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" class="form-control" required id="cfrom" name="cfrom"
                                                    placeholder="e.g 2014">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="textarea">Date To</label>
                                                <input type="date" class="form-control" required id="cto" name="cto"
                                    ...
                                    <section required id="editor" style="margin-bottom: 30px;">
                                        <textarea id="summernote" required name="job_experience" class="summernote"></textarea>
                                    </section>
                                ...
                                <div class="row box mt-3 rounded">
                                    <div class="divider">
                                        <h3><i class="fa fa-trophy text-success" aria-hidden="true"></i>&nbsp;
                                            Employee&nbsp;<span class="text-success">Skills</span></h3>
                                    </div>

                                    <div class="form-group">
                                        <label for="tagPlaces" class="col-sm-12">Skills</label>
                                        <div class="col-sm-12">
                                            <input type="text" value="" data-role="tagsinput" placeholder="Add Skills"
