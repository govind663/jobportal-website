                            ...
                            <div class="page-login-form">
                                ...
                                <form action="{{ route('register.post') }}" method="POST" class="login-form">
                                    ...
                                    <div class="form-group row">
                                        <label for="name" class="col-md-4 col-form-label text-md-right" style="padding-top: 20px; padding-left: 50px;">Name</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="email_address" class="col-md-4 col-form-label text-md-right" style="padding-top: 20px; padding-left: 50px;">E-Mail Address</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="password" class="col-md-4 col-form-label text-md-right" style="padding-top: 20px; padding-left: 50px;">Password</label>
                                        <div class="col-md-6">
                                    ...
                                    <button type="submit" class="btn btn-common log-btn">
                                        <strong><i class="fas fa-sign-in-alt"></i>&nbsp; Register</strong>
                                    </button>
                                    <br>
                                    <br>
