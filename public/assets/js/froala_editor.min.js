    ...
    (b.DEFAULTS = { initOnClick: !1, pluginsEnabled: null }),
                        ...
                        this.opts.iframe
                            ? ((this.$iframe = a(
                              ...
                              (this.iframe_document =
                                  this.$iframe.get(0).contentWindow.document),
        ...
        (b.prototype.load = function (b) {
            for (var c in b)
                if (b.hasOwnProperty(c)) {
                    ...
                    if (
                        a.FE.PLUGINS[c] &&
                        this.opts.pluginsEnabled.indexOf(c) < 0
                    )
                        continue;
                    if (
                        ((this[c] = new b[c](this)),
            ...
            if ("string" == typeof c) {
                ...
                return (
                    this.each(function () {
                        ...
                        if (!e)
                            return console.warn(
                                "Editor should be initialized before calling the " +
                                    c +
                                    " method."
                            );
                        var g, h;
        ...
        (a.FE.MODULES.helpers = function (b) {
            ...
            function n(a) {
                ...
                a = String(a)
                    ...
                    .replace(/ /g, "%20");
                var b =
                    /(http|ftp|https):\/\/[a-z\u00a1-\uffff0-9{}]+(\.[a-z\u00a1-\uffff0-9{}]*)*([a-z\u00a1-\uffff0-9.,@?^=%&amp;:\/~+#-_{}]*[a-z\u00a1-\uffff0-9@?^=%&amp;\/~+#-_{}])?/gi;
                return b.test(a);
            }
            function o(a) {
        ...
        (a.FE.MODULES.events = function (b) {
            ...
            function i(c) {
                ...
                if (
                    ...
                    if (f && !b.node.blockParent(f)) {
                        ...
                        g &&
                            (a(g).prepend(a.FE.MARKERS), b.selection.restore());
                    } else f && a(f).remove();
                }
            }
            function j() {
            ...
            function l(c) {
                ...
                return b.edit.isDisabled() ||
                    b.node.hasClass(d.get(0), "fr-disabled")
                    ? (c.preventDefault(), !1)
            ...
            function m(c, d) {
                ...
                if (
                    b.edit.isDisabled() ||
                    b.node.hasClass(e.get(0), "fr-disabled")
                )
            ...
            function u() {
                t(D, b.id),
                    (D = []),
                    0 === b.shared.count &&
                        (t(b.shared.$_events, b.sid),
                        (b.shared.$_events = null));
            }
            function v(c, d, e) {
        ...
        (a.FE.MODULES.node = function (b) {
            ...
            function e(e, f) {
                ...
                return (
                    !(
                        e.querySelectorAll(a.FE.VOID_ELEMENTS.join(","))
                            .length - e.querySelectorAll("br").length
                    ) &&
                    !e.querySelector(
                    ...
                    !(
                        e.querySelectorAll(a.FE.BLOCK_TAGS.join(",")).length > 1
                    ) &&
                    !e.querySelector(
            ...
            function f(a) {
                for (
                    ...
                    a.parentNode !== b.el &&
                    (!a.parentNode ||
                        !b.node.hasClass(a.parentNode, "fr-inner"));
            ...
            function g(c, e, f) {
                if (
                    ...
                    e.indexOf(c.parentNode) >= 0 ||
                        ...
                        (c.parentNode &&
                            a.FE.SIMPLE_ENTER_TAGS.indexOf(
            ...
            function i(a) {
                for (
                    var b = "", c = h(a), d = Object.keys(c).sort(), e = 0;
                    e < d.length;
                    e++
                ) {
                    var f = d[e],
                        g = c[f];
                    g.indexOf("'") < 0 && g.indexOf('"') >= 0
                        ? (b += " " + f + "='" + g + "'")
                        : g.indexOf('"') >= 0 && g.indexOf("'") >= 0
                        ? ((g = g.replace(/"/g, "&quot;")),
                          (b += " " + f + '="' + g + '"'))
            ...
            function m(a, c) {
                ...
                for (
                    ...
                    d && c && b.node.hasClass(d, "fr-marker");
            ...
            function d(d, e, f) {
                ...
                try {
                    ...
                    if (
                        ...
                        for (
                            g = b.$el.find(
                                'span.fr-marker[data-type="true"][data-id="' +
                                    f +
                                    '"]'
                            ),
                                i = g.get(0).nextSibling;
                            i &&
                    ...
                    if (e === !1 && !d.collapsed) {
                        if (
                            ((g = b.$el
                                .find(
                                    'span.fr-marker[data-type="false"][data-id="' +
                                        f +
                                        '"]'
                                )
                                .get(0)),
        ...
        (a.FE.MODULES.selection = function (b) {
            function c() {
                ...
                return (
                    b.win.getSelection
                        ...
                        : b.doc.selection &&
                          (a = b.doc.selection.createRange().text),
                    a.toString()
                );
            }
            function d() {
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    for (
                                        g = i.childNodes[h.startOffset - 1];
                                        g &&
                                        g.nodeType == Node.TEXT_NODE &&
                                        0 === g.textContent.length;
                            ...
                            !j &&
                                ...
                                a(i.childNodes[0])
                                    ...
                                    c().replace(/\u200B/g, "") &&
                                ["BR", "IMG", "HR"].indexOf(
                                    i.childNodes[0].tagName
                                ) < 0 &&
                                (i = i.childNodes[0]);
                        }
                        for (
                            ;
                            i.nodeType != Node.ELEMENT_NODE && i.parentNode;
            ...
            function m(c, d, e) {
                ...
                return g &&
                    ...
                    ? ((f = g.textContent.length),
                      e
                          ? ((h.textContent = g.textContent + h.textContent),
                            a(g).remove(),
                            a(c).remove(),
                    ...
                    b.node.hasClass(g, "fr-marker")
                        ...
                        ? a(g).find(".fr-marker").length > 0
                            ...
                            ? 0 === a(g).find(".fr-inner").length
                                ? a(g).html("<br>")
                                : a(g).find(".fr-inner").filter(s).html("<br>")
            ...
            function u() {
                try {
                    if (!b.$wp) return !1;
                    for (
                        var a = e(0), c = a.commonAncestorContainer;
                        c && !b.node.isElement(c);
                        ...
                        for (
                            ...
                            if (q) {
                                if (m && (!p || p != q)) {
                                    ...
                                    if (
                                        (r &&
                                            ["UL", "OL"].indexOf(r.tagName) >=
                                                0 &&
                                            ((r = null), (u = !0)),
                                        s &&
                                            ["UL", "OL"].indexOf(s.tagName) >=
                                                0 &&
                                            ((s = null), (v = !0)),
                                        a(m).after(q),
                                        r != s)
            ...
            function y(c, d) {
                ...
                return e
                    ? (b.node.isBlock(e)
                      ...
                      !0)
                    : !!d &&
                          (b.node.isBlock(c) ? w(c) : a(c).before(a.FE.MARKERS),
                          !0);
            }
            function z(c, d) {
                "undefined" == typeof d && (d = !0);
                ...
                return e
                    ...
                    : !!d &&
                          (b.node.isBlock(c) ? x(c) : a(c).after(a.FE.MARKERS),
                          !0);
            }
            return {
                text: c,
        ...
        (a.FE.MODULES.clean = function (b) {
            function c(a) {
                ...
                if (
                    ...
                    for (d = 0; d < e.length; d++)
                        if (
                            (e[d].getAttribute("class") || "").indexOf(
                                "fr-marker"
                            ) < 0
                        )
                            return !1;
                ...
                return (
                    ...
                    (a = a.replace(
                        ...
                        function (a) {
                            return (
                                L.push(a),
                                "[FROALA.EDITOR.SCRIPT " + (L.length - 1) + "]"
                            );
                        }
                    )),
                    (a = a.replace(
            ...
            function f(a) {
                return (
                    ...
                    (a = a.replace(
                        ...
                        function (a, c) {
                            return b.opts.htmlRemoveTags.indexOf("noscript") >=
                                0
                                ? ""
                                : L[parseInt(c, 10)]
                                      .replace(/\&lt;/g, "<")
                ...
                for (c in a)
                    if (a.hasOwnProperty(c)) {
                        ...
                        b.opts.htmlAllowedStyleProps.length &&
                            ...
                            "style" == c && d
                                ? (a[c] = g(d.join(";")))
                                : c.match(J) || delete a[c];
                    }
                for (
                    var e = "", f = Object.keys(a).sort(), h = 0;
                    h < f.length;
                    h++
                )
                    (c = f[h]),
            ...
            function n() {
                var c = b.el.querySelectorAll(
                    Object.keys(a.FE.HTML5Map).join(",")
                );
                if (c.length) {
                    var d = !1;
            ...
            function o(c) {
                ...
                if (
                    ...
                    c.nodeType == Node.ELEMENT_NODE &&
                        ...
                        ["TABLE", "TBODY", "TFOOT", "TR"].indexOf(c.tagName) >=
                            0 && (c.innerHTML = c.innerHTML.trim())),
            ...
            function r(c, d, e, f) {
                ...
                return (
                    i.push("data-fr-.*"),
                    i.push("fr-.*"),
                    (H = new RegExp("^" + h.join("$|^") + "$", "gi")),
                    (J = new RegExp("^" + i.join("$|^") + "$", "gi")),
                    (I = new RegExp(
                        "^" + b.opts.htmlRemoveTags.join("$|^") + "$",
                        "gi"
                    )),
                    (K = b.opts.htmlAllowedStyleProps.length
                        ? new RegExp(
                              "((^|;|\\s)" +
                                  b.opts.htmlAllowedStyleProps.join(
                                      ":.+?(?=;|$))|((^|;|\\s)"
                                  ) +
                                  ":.+?(?=(;|')|$))",
                              "gi"
            ...
            function s() {
                for (
                    var c = b.el.querySelectorAll("blockquote + blockquote"),
                        d = 0;
                    d < c.length;
                    d++
                ) {
                    var e = c[d];
                    b.node.attributes(e) ==
                        b.node.attributes(e.previousSibling) &&
                        (a(e).prev().append(a(e).html()), a(e).remove());
                }
            }
            function t() {
                for (
                    var a = b.el.querySelectorAll("tr"), c = 0;
                    c < a.length;
                    c++
                ) {
                    for (
                        var d = a[c].children, e = !0, f = 0;
                        f < d.length;
                        f++
                    )
                        if ("TH" != d[f].tagName) {
                    ...
                    if (e !== !1 && 0 !== d.length) {
                        for (
                            var g = a[c];
                            g && "TABLE" != g.tagName && "THEAD" != g.tagName;
            ...
            function w() {
                ...
                do {
                    ...
                    a = [];
                    for (
                        var g = b.el.querySelectorAll("li"), h = 0;
                        h < g.length;
                        h++
                    )
                        c(g[h]) && a.push(g[h]);
            ...
            function x() {
                for (
                    var a = b.el.querySelectorAll("ol + ol, ul + ul"), c = 0;
                    c < a.length;
                    c++
                ) {
                    var d = a[c];
                    if (
                        ...
                        b.node.openTagString(d) ==
                            b.node.openTagString(d.previousSibling)
                    ) {
                        for (
                            var e = b.node.contents(d), f = 0;
                            f < e.length;
                            f++
                        )
            ...
            function y() {
                var a,
                    ...
                    d = function (a) {
                        a.querySelector("LI") ||
                            ((c = !0), a.parentNode.removeChild(a));
                    };
                do {
                    c = !1;
            ...
            function A() {
                for (
                    var c = b.el.querySelectorAll("li > ul, li > ol"), d = 0;
                    d < c.length;
                    d++
                ) {
                    var e = c[d];
            ...
            function C() {
                for (
                    var c = b.el.querySelectorAll("li:empty"), d = 0;
                    d < c.length;
                    d++
                )
                    a(c[d]).remove();
            ...
            function D() {
                for (
                    var c = b.el.querySelectorAll("ul, ol"), d = 0;
                    d < c.length;
                    d++
                )
                    for (
                        var e = b.node.contents(c[d]),
                            f = null,
                            g = e.length - 1;
                        g >= 0;
                        g--
                        ...
                        "LI" != e[g].tagName
                            ? (f || ((f = a("<li>")), f.insertBefore(e[g])),
                              f.prepend(e[g]))
                            : (f = null);
            }
            function E() {
                for (
                    default_tag_els = b.el.querySelectorAll(
                        b.html.defaultTag()
                    ),
                        i = default_tag_els.length - 1;
                    i >= 0;
                    i--
                )
                    (el = default_tag_els[i]),
                        el.parentNode &&
                            "LI" == el.parentNode.tagName &&
                            (el.nextElementSibling &&
                                el.nextElementSibling.tagName.toLowerCase() ==
                                    b.html.defaultTag() &&
                                a("<br>").insertBefore(el.nextElementSibling),
                            el.previousElementSibling &&
                                el.previousElementSibling.tagName.toLowerCase() ==
                                    b.html.defaultTag() &&
                                a("<br>").insertAfter(
                                    el.previousElementSibling
                                ),
        ...
        (a.FE.MODULES.spaces = function (b) {
                ...
                if ("PRE" != h.tagName) {
                    d &&
                        ...
                        (f && "BR" !== f.tagName && !b.node.isBlock(f)) ||
                            !b.node.isBlock(h) ||
                            (g = g.replace(/[\f\n\r\t\v ]{1,}$/g, "")),
                        (e && "BR" !== e.tagName && !b.node.isBlock(e)) ||
                            !b.node.isBlock(h) ||
                            (g = g.replace(/^[\f\n\r\t\v ]{1,}/g, "")),
                        " " === g &&
                            ...
                            (g = "")),
                        (g = g.replace(
                            new RegExp(a.FE.UNICODE_NBSP, "g"),
                            " "
                        ));
                    for (var i = "", j = 0; j < g.length; j++)
                        i +=
                            32 != g.charCodeAt(j) ||
                            (0 !== j && 32 != i.charCodeAt(j - 1))
                                ? g[j]
                                : a.FE.UNICODE_NBSP;
                    (!f ||
                        b.node.isBlock(f) ||
            ...
            function e() {
                for (
                    ...
                    f = g ? g : c[e];
                    for (
                        var h = f.nextSibling, i = f.previousSibling;
                        h && "BR" == h.tagName;
        ...
        (a.FE.MODULES.html = function (b) {
            ...
            function d(c) {
                ...
                var l = f();
                for (
                    l += "," + a.FE.VOID_ELEMENTS.join(","),
                        l +=
                            "," +
                            b.opts.htmlAllowedEmptyTags.join(
                                ":not(.fr-marker),"
                            ) +
                            ":not(.fr-marker)",
                        d = g.length - 1;
                        ...
                        !(
                            (g[d].textContent &&
                                g[d].textContent.replace(/\u200B|\n/g, "")
                                    .length > 0) ||
                            g[d].querySelectorAll(l).length > 0
                        )
                    ) {
                        for (
                            var m = b.node.contents(g[d]), n = !1, o = 0;
                            o < m.length;
                            o++
                        )
                            if (
                                m[o].nodeType != Node.COMMENT_NODE &&
                                m[o].textContent &&
                ...
                if ((d && (e = "div"), e)) {
                    for (
                        ...
                        if (
                            i.nodeType == Node.ELEMENT_NODE &&
                            (b.node.isBlock(i) ||
                                (b.opts.htmlDoNotWrapTags.indexOf(
                            ...
                            null == g
                                ? ((g = b.doc.createElement(e)),
                                  d && g.setAttribute("data-empty", !0),
                                  g.appendChild(i),
                                  f.appendChild(g))
                                : h === !1 &&
            ...
            function j(a, c, d, e) {
                return (
                    ...
                    h(b.el, a),
                    e && i(b.el.querySelectorAll(".fr-inner"), a),
                    c && i(b.el.querySelectorAll("td, th"), a),
                    void (d && i(b.el.querySelectorAll("blockquote"), a)))
                );
            }
            function k() {
                b.$el.find("div.fr-temp-div").each(function () {
                    a(this).data("empty") ||
                    "LI" == this.parentNode.tagName ||
            ...
            function l(c) {
                ...
                if (b.browser.msie && b.opts.enter == a.FE.ENTER_BR) {
                    ...
                    h.length &&
                        h[h.length - 1].nodeType == Node.TEXT_NODE &&
                        b.$el.append("<br>");
                }
            }
            function m() {
                ...
                for (
                    ...
                    if ("PRE" != d.parentNode.tagName) {
                        ...
                        if (e) {
                            ...
                            g && h && " " == f
                                ? (f =
                                      b.node.isBlock(g) && b.node.isBlock(h)
                                          ? ""
                                          : "\n")
                                : (g || (f = f.replace(/^ */, "")),
                                  h || (f = f.replace(/ *$/, "")));
            ...
            function s() {
                ...
                for (c = 0; c < e.length; c++)
                    for (
                        var i = e[c].querySelectorAll("br"), j = 0;
                        j < i.length;
                        j++
                    )
            ...
            function t(a, c) {
                var d,
                    e = null;
                if (a) for (e = s(), d = 0; d < e.length; d++) r(e[d], c);
                else
                    for (
                        e = b.el.getElementsByTagName("br"), d = 0;
                        d < e.length;
                        d++
                    )
                        r(e[d], c);
            ...
            function B(a) {
                if (
                    ...
                    for (
                        var c = a.querySelectorAll('[class=""]'), d = 0;
                        d < c.length;
                        d++
                    )
            ...
            function E() {
                ...
                if ("undefined" != typeof b.win.getSelection) {
                    b.browser.mozilla &&
                        (b.selection.save(),
                        b.$el.find('.fr-marker[data-type="false"]').length >
                            1 &&
                            (b.$el
                                .find(
                    ...
                    for (
                        ...
                        if (i.length) {
                            var j = i[i.length - 1];
                            (("P" == j.tagName &&
                                b.opts.enter == a.FroalaEditor.ENTER_P) ||
                                ("DIV" == j.tagName &&
                                    b.opts.enter ==
                                        a.FroalaEditor.ENTER_DIV)) &&
                                b.node.isEmpty(j) &&
                                h.removeChild(j);
                        }
                        c(h, d()),
            ...
            function I(a, c, d) {
                ...
                var e;
                if (
                    ((e = c ? a : b.clean.html(a)),
                    (e = e.replace(/\r|\n/g, " ")),
                    a.indexOf('class="fr-marker"') < 0 && (e = G(e)),
                    b.core.isEmpty() && !b.opts.keepFormatOnDelete)
                )
                    b.el.innerHTML = e;
                else {
                    var f = b.markers.insert();
                    if (f) {
                        ...
                        if (
                            ...
                            if (((f = b.markers.split()), !f)) return !1;
                            f.outerHTML = e;
                        } else f.outerHTML = e;
            ...
            function J(c) {
                ...
                if (
                    ...
                    return !1;
                var e = d
                        ? (d.textContent.match(/\u200B/g) || []).length -
                          d.querySelectorAll(".fr-marker").length
                        : 0,
                    f =
        ...
        (a.FE.MODULES.placeholder = function (b) {
            function c() {
                ...
                if (j.length && j[0].nodeType == Node.ELEMENT_NODE) {
                    ...
                    !b.opts.toolbarInline &&
                        b.ready &&
                        ((c = b.helpers.getPX(l.css("margin-top"))),
                        (f = b.helpers.getPX(l.css("padding-top"))),
                        (d = b.helpers.getPX(l.css("margin-left"))),
                        (e = b.helpers.getPX(l.css("margin-right"))),
                        (h = b.helpers.getPX(l.css("padding-left"))),
                        (i = b.helpers.getPX(l.css("padding-right")))),
                        b.$placeholder.css("font-size", l.css("font-size")),
                        b.$placeholder.css("line-height", l.css("line-height"));
                } else
                    ...
                    b.$placeholder
                        .css({
                            ...
                            marginRight: Math.max(
                                b.helpers.getPX(b.$el.css("margin-right")),
                                e
                            ),
                            textAlign: k,
                        })
                        .text(
                            b.language.translate(
                                b.opts.placeholderText ||
                                    b.$oel.attr("placeholder") ||
                                    ""
                            )
                        ),
                    b.$placeholder.html(
                        b.$placeholder.text().replace(/\n/g, "<br>")
                    );
            }
            function d() {
            ...
            function e() {
                return (
                    !b.$wp || b.node.hasClass(b.$wp.get(0), "show-placeholder")
                );
            }
            function f() {
        ...
        a.extend(a.FE.DEFAULTS, {
            ...
            spellcheck: !0,
            iframeStyle:
                'html{margin:0px;height:auto;}body{height:auto;padding:10px;background:transparent;color:#000000;position:relative;z-index: 2;-webkit-user-select:auto;margin:0px;overflow:hidden;min-height:20px;}body:after{content:"";display:block;clear:both;}',
            iframeStyleFiles: [],
            direction: "auto",
            zIndex: 1,
            disableRightClick: !1,
        ...
        (a.FE.MODULES.core = function (b) {
            function c(c) {
                if (b.opts.iframe) {
                    b.$head
                        ...
                        .remove(),
                        b.$head.append(
                            '<style data-fr-style="true">' + c + "</style>"
                        );
            ...
            function e() {
                if (
                    (b.$box.addClass(
                        "fr-box" +
                            (b.opts.editorClass ? " " + b.opts.editorClass : "")
                    ),
                    ...
                    for (var a = 0; a < b.o_doc.styleSheets.length; a++) {
                        ...
                        if (c)
                            for (var f = 0, g = c.length; f < g; f++)
                                !c[f].selectorText ||
                                    (0 !==
                                        c[f].selectorText.indexOf(".fr-view") &&
                                        0 !==
                                            c[f].selectorText.indexOf(
                                                ".fr-element"
                                            )) ||
            ...
            function j() {
                return b.browser.mozilla && b.helpers.isMobile()
                    ...
                    : b.node.hasFocus(b.el) || b.$el.find("*:focus").length > 0;
            }
            function k(a) {
                if (!a) return !1;
        ...
        (a.FE.MODULES.cursorLists = function (b) {
                    ...
                    (i && h) || !b.node.isEmpty(g, !0)
                        ...
                        ? ((f = d(g)),
                          f.parentNode && "LI" == f.parentNode.tagName
                              ? a(f.parentNode).after(
                                    "<li>" + a.FE.MARKERS + "<br></li>"
                                )
                              : j
                              ? a(f).after(
                                    "<" +
            ...
            function f(d) {
                for (var e = c(d), f = "", g = d, h = "", i = ""; g != e; ) {
                    g = g.parentNode;
                    var j =
                        "A" == g.tagName && b.cursor.isAtEnd(d, g)
                            ? "fr-to-remove"
                            : "";
                    (h =
                        b.node.openTagString(a(g).clone().addClass(j).get(0)) +
                        h),
            ...
            function g(d) {
                for (
                    var e = c(d), f = a.FE.MARKERS, g = "", h = d, i = !1;
                    h != e;

                ) {
                    h = h.parentNode;
                    var j =
                        "A" == h.tagName && b.cursor.isAtEnd(d, h)
                            ? "fr-to-remove"
                            : "";
                    i ||
                        h == e ||
                ...
                if (g) {
                    ...
                    if (
                        ...
                        m && 0 === a(f).find(b.html.blockTagsQuery()).length
                            ...
                            : (a(k).before(a(f).html()), b.html.wrap());
                    }
                    a(f).remove(),
            ...
            function i(d) {
                ...
                if (g) {
                    ...
                    for (
                        var h, i = d, j = b.node.contents(g)[0];
                        j && !b.node.isList(j);
                        ...
                        for (
                            e = b.node.contents(f),
                                e.length &&
                                    ...
                                    a(e[e.length - 1]).remove(),
                                a(d).replaceWith(a.FE.MARKERS);
                            k && !b.node.isBlock(k) && "BR" != k.tagName;
        ...
        (a.FE.MODULES.cursor = function (b) {
            function c(a) {
                return (
                    ...
                    (!!b.node.isBlock(a) ||
                        ...
                        0 ===
                            a.nextSibling.textContent.replace(/\u200b/g, "")
                                .length
                            ? c(a.nextSibling)
            ...
            function d(a) {
                return (
                    ...
                    (!!b.node.isBlock(a) ||
                        ...
                        0 ===
                            a.previousSibling.textContent.replace(/\u200b/g, "")
                                .length
                            ? d(a.previousSibling)
            ...
            function f(a, c) {
                return (
                    ...
                    a.nextSibling.nodeType == Node.TEXT_NODE &&
                    0 ===
                        a.nextSibling.textContent.replace(/\u200b/g, "").length
                        ? f(a.nextSibling, c)
                        : !a.nextSibling &&
            ...
            function h(c) {
                ...
                if (e && "BLOCKQUOTE" == e.tagName) {
                    var f = b.node.deepestParent(c, [
                        a(c).parentsUntil(b.$el, "BLOCKQUOTE").get(0),
                    ]);
            ...
            function i(c) {
                ...
                if (!b.node.isBlock(d) && b.node.isEditable(d)) {
                    ...
                    if (b.node.isDeletable(d))
                        ...
                        for (
                            b.node.isList(d) &&
                                (d = a(d).find("li:last").get(0)),
                                e = b.node.contents(d),
                                e &&
                                    "BR" == e[e.length - 1].tagName &&
                                    a(e[e.length - 1]).remove(),
                                e = b.node.contents(d);
                            e && b.node.isBlock(e[e.length - 1]);
                        ...
                        for (
                            ;
                            j && "BR" !== j.tagName && !b.node.isBlock(j);
            ...
            function j() {
                ...
                if (l) {
                    ...
                    m &&
                        ...
                        (1 == m.length
                            ? a(l).remove()
                            : ((l.textContent = l.textContent.substr(
                                  0,
                                  m.length - 1
                              )),
                              l.textContent.length &&
                                  55357 ==
                                      l.textContent.charCodeAt(
                ...
                return (
                    c(j)
                        ? (f = i(j))
                        : d(j)
                        ? g(j) && e(j, a(j).parents("li:first").get(0))
                                ...
                                if (b.node.isEmpty(e, !0))
                                    ...
                                    "BLOCKQUOTE" == e.tagName &&
                                        ...
                                        0 === i.find("ul, ol").length &&
                                            ...
                                            a(e).append(
                                                b.node.contents(i.get(0))
                                            ),
                                            i.remove(),
                                            0 === a(h).find("li").length &&
                                                a(h).remove());
                                }
                            else {
                                if (
                ...
                if (
                    ...
                    if (e.nextSibling) {
                        if (
                            ...
                            if (
                                !(
                                    a.FE.NO_DELETE_TAGS.indexOf(
                                        e.nextSibling.tagName
                                    ) < 0
                                )
                            )
                ...
                if (!b.node.isBlock(e) && b.node.isEditable(e)) {
                    ...
                    if (b.node.isDeletable(e))
                        ...
                        d.previousSibling
                            ...
                            : (a(e).find("li:first").prepend(a.FE.MARKERS),
                              a(d).remove());
                    else if (
                        ((h = b.node.contents(e)),
            ...
            function m() {
                ...
                if ((b.el.normalize(), c(e)))
                    if (g(e))
                        if (
                            0 === a(e).parents("li:first").find("ul, ol").length
                        )
            ...
            function o() {
                b.$el.find(".fr-to-remove").each(function () {
                    for (
                        var c = b.node.contents(this), d = 0;
                        d < c.length;
                        d++
                    )
            ...
            function p(c, d, e) {
                ...
                if (null == h)
                    (g = b.html.defaultTag()),
                        g && b.node.isElement(c.parentNode)
                            ? a(c).replaceWith(
                                  "<" +
                                      g +
                                      ">" +
            ...
            function q(c, d, g) {
                ...
                if (i && "TABLE" == i.tagName)
                    return (
                        a(i).find("td:first, th:first").prepend(c), q(c, d, g)
                    );
                ...
                if (null == i)
                    (h = b.html.defaultTag()),
                        h && b.node.isElement(c.parentNode)
                            ? a(c).replaceWith(
                                  "<" +
                                      h +
                                      ">" +
                    ...
                    if (b.node.isBlock(i))
                        if (d)
                            ...
                            a(i).before(
                                b.node.openTagString(
                                    a(i).clone().removeAttr("id").get(0)
                                ) +
                                    "<br>" +
                                    b.node.closeTagString(i)
                            );
                        }
                    else a(i).before("<br>");
                    a(c).remove();
            ...
            function r(c, d, g) {
                ...
                if (null == h)
                    ...
                    var o =
                        (h == c.parentNode && b.node.isBlock(h)) ||
                        c.nextSibling;
        ...
        (a.FE.MODULES.keys = function (b) {
            ...
            function e(a) {
                b.selection.isCollapsed()
                    ? b.cursor.backspace() ||
                      (a.preventDefault(), a.stopPropagation(), (z = !1))
                    : (a.preventDefault(),
                      a.stopPropagation(),
                      b.selection.remove(),
                      b.html.fillEmptyBlocks(),
            ...
            function o() {
                ...
                b.opts.height || b.opts.heightMax
                    ? ((c = b.position.getBoundingRect().top),
                      b.helpers.isIOS() && (c -= b.helpers.scrollTop()),
                    ...
                    : ((c = b.position.getBoundingRect().top),
                      ...
                      c < b.$tb.height() + 20 &&
                          a(b.o_win).scrollTop(
                              c + b.helpers.scrollTop() - b.$tb.height() - 20
                          ));
            }
            function p() {
            ...
            function q(c) {
                ...
                if (
                    c &&
                    (c.which === a.FE.KEYCODE.META ||
                        c.which == a.FE.KEYCODE.CTRL)
                )
                    return !0;
                if (c && s(c.which)) return !0;
                c && c.which == a.FE.KEYCODE.ENTER && b.helpers.isIOS() && p(),
                    c &&
                        (c.which == a.FE.KEYCODE.ENTER ||
                            ...
                            (c.which >= 37 &&
                                c.which <= 40 &&
                                !b.browser.msie)) &&
                        ((c.which == a.FE.KEYCODE.BACKSPACE && z) || o()),
                    b.html.cleanBRs(!0, !0);
                var d = function (a) {
                        if (!a) return !1;
                        var b = a.innerHTML;
            ...
            function s(b) {
                if (
                    b >= a.FE.KEYCODE.ARROW_LEFT &&
                    b <= a.FE.KEYCODE.ARROW_DOWN
                )
                    return !0;
            }
            function t(c) {
                ...
                if (
                    c >= a.FE.KEYCODE.NUM_ZERO &&
                    c <= a.FE.KEYCODE.NUM_MULTIPLY
                )
                    return !0;
            ...
            function y() {
                if (
                    (b.events.on("keydown", u),
                    b.events.on("input", h),
                    b.events.on("keyup input", v),
                    b.events.on("keypress", k),
        ...
        (a.FE.MODULES.accessibility = function (b) {
            function c(a) {
                if (a && a.length) {
                    ...
                    var c =
                        a.parents(".fr-toolbar, .fr-popup").data("instance") ||
                        b;
            ...
            function d(a, b) {
                var d = b ? "last" : "first",
                    e = a
                        .find(
                            "button:visible:not(.fr-disabled), .fr-group span.fr-command:visible"
                        )
                        [d]();
            ...
            function t() {
                b.shared.$f_el &&
                    ...
                    b.shared.$f_el.blur(),
                    (b.shared.$f_el = null)),
                    b.events.trigger("toolbar.focusEditor") !== !1 &&
                        (b.events.disableBlur(), b.events.focus());
            }
            function u(a) {
                if (b.shared.$f_el) {
                        ...
                        d
                            ...
                            ? ((b.shared.with_kb = !1),
                              b.opts.toolbarInline &&
                                  (b.events.disableBlur(), b.events.focus()),
                              b.button.exec(
                                  a.parent().find(".fr-back:visible:first")
                              ),
                              z(a.parent()))
                            : b.shared.$f_el.is("button, .fr-group span") &&
                              (a.parent().is(".fr-popup")
                                  ? (h(b),
                                    (b.shared.$f_el = null),
                                    b.events.trigger("toolbar.esc") !== !1 &&
                                        (b.popups.hide(a.parent()),
                                        b.opts.toolbarInline &&
            ...
            function v(c, d) {
                var e =
                    ...
                    g = !1;
                return (
                    f != a.FE.KEYCODE.TAB || e || c.shiftKey || c.altKey
                        ? f != a.FE.KEYCODE.ARROW_RIGHT ||
                          e ||
                          c.shiftKey ||
                          c.altKey
                            ? f != a.FE.KEYCODE.TAB ||
                              ...
                              !c.shiftKey ||
                              c.altKey
                                ? f != a.FE.KEYCODE.ARROW_LEFT ||
                                  e ||
                                  c.shiftKey ||
                                  c.altKey
                                    ? f != a.FE.KEYCODE.ARROW_UP ||
                                      e ||
                                      c.shiftKey ||
                                      c.altKey
                ...
                c &&
                    ...
                    (b.events.$on(
                        ...
                        function (d) {
                            if (
                                ...
                                return !0;
                            var e =
                                c.parents(".fr-popup").data("instance") ||
                                c.data("instance") ||
                                b;
                            b.shared.with_kb = !0;
                    ...
                    b.events.$on(
                        ...
                        function (d) {
                            ...
                            if (!F)
                                return (
                                    d.stopPropagation(), void d.preventDefault()
                                );
                        ...
                        if (a.FE.KEYCODE.TAB == j) {
                            ...
                            if (a.FE.KEYCODE.ENTER != j)
                                return a.FE.KEYCODE.ESC == j
                                    ? (g.preventDefault(),
                                      ...
                                      e.find(".fr-back:visible").length
                                          ? (i.opts.toolbarInline &&
                                                ...
                                                i.events.focus()),
                                            i.button.exec(
                                                e.find(".fr-back:visible:first")
                                            ),
                                            z(e))
                                          : i.popups.isVisible(c) &&
                                            e.find(".fr-dismiss:visible").length
                                          ? i.button.exec(
                                                e.find(
                                                    ".fr-dismiss:visible:first"
                                                )
                                            )
                                          : (i.popups.hide(c),
                                            i.opts.toolbarInline &&
                                                i.toolbar.showInline(null, !0),
                                            z(e)),
                                      !1)
                                    ...
                                    : a.FE.KEYCODE.SPACE == j &&
                                      (k.is(".fr-link-attr") ||
                                          k.is("input[type=file]"))
                                    ? void g.stopPropagation()
                                    : (g.stopPropagation(),
                                      g.preventDefault(),
                                      !1);
                            var p = null;
                            e.find(".fr-submit:visible").length > 0
                                ? (p = e.find(".fr-submit:visible:first"))
                                : e.find(".fr-dismiss:visible").length &&
                                  (p = e.find(".fr-dismiss:visible:first")),
                                p &&
                                    (g.preventDefault(),
                                    g.stopPropagation(),
                                    i.events.disableBlur(),
            ...
            function D(c) {
                ...
                if (e == a.FE.KEYCODE.F10 && !d && !c.shiftKey && c.altKey) {
                    ...
                    var g = b.popups.areVisible(b),
                        h = !1;
                    return (
                        g && (h = f(g.children().not(".fr-buttons"))),
                        h || k(),
                        (b.shared.with_kb = !1),
                        c.preventDefault(),
                        c.stopPropagation(),
        ...
        (a.FE.MODULES.format = function (b) {
            ...
            function g(d, e, f) {
                if (d) {
                    ...
                    for (
                        var h = a(c(e, f)).insertBefore(d), i = d;
                        i &&
                        !a(i).is(".fr-marker") &&
                    ...
                    if (i)
                        ...
                        for (
                            var k = h.get(0).parentNode;
                            k && !k.nextSibling && !b.node.isElement(k);
            ...
            function h(h, i) {
                ...
                if (
                    ...
                    k.replaceWith(
                        c(h, i) + a.FE.INVISIBLE_SPACE + a.FE.MARKERS + d(h)
                    ),
                        b.selection.restore();
                } else {
                    b.selection.save();
                    ...
                    for (j = 0; j < n.length; j++) {
                        var o = a(n[j]);
                        o.data("type") === !0
                            ? f(o.get(0).nextSibling, e(h, i)) &&
                              o.next().prepend(o)
                            : f(o.get(0).previousSibling, e(h, i)) &&
                              o.prev().append(o);
                    }
                    b.selection.restore();
                }
            ...
            function j(c, d, g, h) {
                for (
                    var i = b.node.contents(c.get(0)), k = 0;
                    k < i.length;
                    k++
                ) {
                    var l = i[k];
            ...
            function o(c, d) {
                ...
                if (b.selection.isCollapsed()) {
                    ...
                    var h = f.parent();
                    if (
                        b.node.openTagString(h.get(0)) ==
                        '<span style="' + c + ": " + h.css(c) + ';">'
                    )
                        ...
                        b.node.isEmpty(h.get(0)) && h.is("span")
                            ? (f.replaceWith(a.FE.MARKERS), h.css(c, d))
                            : f.replaceWith(
                                  '<span style="' +
                                      c +
                                      ": " +
                    ...
                    if (
                        ...
                        null == d ||
                            ("color" == c &&
                                b.$el.find(".fr-marker").parents("u, a")
                                    .length > 0))
                    ) {
                        var k = b.$el.find(".fr-marker");
                    ...
                    for (
                        ...
                        if (((s = s.not(t)), s.length)) {
                            ...
                            var z =
                                ...
                                x +
                                p.css(c, "").get(0).outerHTML +
                                w +
                                "</span>" +
                                v;
                            p.replaceWith('<span id="fr-break"></span>');
                            var A = s.get(0).outerHTML;
                            a(s.get(0)).replaceWith(
                                A.replace(/<span id="fr-break"><\/span>/g, z)
                            );
                        }
                    }
            ...
            function q(a, c) {
                ...
                for (
                    var h = g;
                    h && h.nodeType == Node.ELEMENT_NODE && !f(h, e(a, c));
        ...
        (a.FE.MODULES.commands = function (b) {
            ...
            function d(c, d) {
                if (
                    ...
                    var e =
                            (a.FE.COMMANDS[c] && a.FE.COMMANDS[c].callback) ||
                            i[c],
                        f = !0,
                        g = !1;
                    a.FE.COMMANDS[c] &&
                        ...
                        "undefined" !=
                            typeof a.FE.COMMANDS[c].accessibilityFocus &&
                            (g = a.FE.COMMANDS[c].accessibilityFocus)),
                        ((!b.core.hasFocus() && f && !b.popups.areVisible()) ||
                            (!b.core.hasFocus() &&
                                g &&
                                b.accessibility.hasFocus())) &&
                            b.events.focus(!0),
                        a.FE.COMMANDS[c] &&
            ...
            function h() {
                b.events.on("keydown", function (a) {
                    ...
                    b.events.on("keyup", function (c) {
                        ...
                        if (d && "HR" == d.tagName)
                            if (
                                c.which == a.FE.KEYCODE.ARROW_LEFT ||
                                ...
                                (c.which == a.FE.KEYCODE.ARROW_RIGHT ||
                                    c.which == a.FE.KEYCODE.ARROW_DOWN) &&
                                d.nextSibling
                            )
                                return (
                                    b.node.isBlock(d.nextSibling)
                                        ? b.selection.setAtStart(d.nextSibling)
                                        : a(d).after(a.FE.MARKERS),
                                    b.selection.restore(),
                                    !1
                                );
            ...
            var i = {
                    ...
                    insertHR: function () {
                        ...
                        var f;
                        e.prev().is("hr")
                            ? (f = b.selection.setAfter(e.get(0), !1))
                            : e.next().is("hr")
                            ? (f = b.selection.setBefore(e.get(0), !1))
                            : b.selection.setAfter(e.get(0), !1) ||
                              b.selection.setBefore(e.get(0), !1),
                            f ||
                                "undefined" == typeof f ||
                                ((d = a.FE.MARKERS + "<br>"),
                                (d = c(d)),
        ...
        (a.FE.MODULES.data = function (a) {
            ...
            function i() {
                var c = (localStorage && localStorage.FEK) ||
                    a.opts.key || [""];
        ...
        (a.FE.MODULES.paste = function (b) {
            ...
            function d(a) {
                ...
                if (
                    ...
                    if (
                        ((o = ""),
                        (p = a.clipboardData.getData("text/rtf")),
                        /text\/html/.test(c)
            ...
            function h(a) {
                return a.match(
                    /(class=\"?Mso|class=\'?Mso|style=\"[^\"]*\bmso\-|style=\'[^\']*\bmso\-|w:WordDocument)/gi
                );
            }
            function i() {
                var c,
                ...
                if ((m && "string" == typeof m && (o = m), !k)) {
                    ...
                    (b.opts.htmlAllowedStyleProps =
                        ...
                        (b.opts.htmlAllowedStyleProps = n),
                ...
                var r = !1;
                if (
                    (o.indexOf('id="docs-internal-guid') >= 0 &&
                        ((o = o.replace(
                    ...
                    k &&
                        !b.wordPaste &&
                        ((o = o.replace(/^\n*/g, "").replace(/^ /g, "")),
                        0 === o.indexOf("<colgroup>") &&
                            (o = "<table>" + o + "</table>"),
                        (o = f(o)),
                        (o = l(o))),
                    b.opts.pastePlain && (o = g(o)),
                    (m = b.events.chainTrigger("paste.afterCleanup", o)),
                    "string" == typeof m && (o = m),
                    "" !== o)
                ) {
                    ...
                    for (c = t.length - 1; c >= 0; c--) {
                        var u = t[c];
                        0 === u.attributes.length &&
                            (u.outerHTML = u.innerHTML);
                    }
                    var v = s.children;
                    if (
                        (1 == v.length &&
                            ["OL", "UL"].indexOf(v[0].tagName) >= 0 &&
                    ...
                    if (b.opts.enter == a.FE.ENTER_BR)
                        for (
                            d = s.querySelectorAll("p, div"), c = d.length - 1;
                            c >= 0;
                            c--
                        )
                            (e = d[c]),
                        ...
                        for (
                            d = s.getElementsByTagName("p"), c = d.length - 1;
                            c >= 0;
                            c--
                        )
                            (e = d[c]),
            ...
            function l(a) {
                ...
                for (
                    var e = d.querySelectorAll(
                        "*:empty:not(br):not(img):not(td):not(th)"
                    );
                    e.length;
                ...
                if (!f) {
                    ...
                    for (var d in a.FE.SHORTCUTS_MAP)
                        a.FE.SHORTCUTS_MAP.hasOwnProperty(d) &&
                            b.opts.shortcutsEnabled.indexOf(
        ...
        (a.FE.MODULES.snapshot = function (a) {
            function b(a) {
                for (
                    var b = a.parentNode.childNodes, c = 0, d = null, e = 0;
                    e < b.length;
                    e++
                ) {
                    if (d) {
            ...
            function f() {
                ...
                if (
                    ...
                    (b.html = (
                        a.$wp ? a.$el.html() : a.$oel.get(0).outerHTML
                    ).replace(/ style=""/g, "")),
                    (b.ranges = []),
        ...
        (a.FE.MODULES.icon = function () {
            ...
            function c(b) {
                ...
                return "undefined" != typeof c
                    ? (d = c.template || a.FE.ICON_DEFAULT_TEMPLATE)
                    : d;
            }
            return { create: b, getTemplate: c };
        }),
        a.extend(a.FE.DEFAULTS, { tooltips: !0 }),
        (a.FE.MODULES.tooltip = function (b) {
            ...
            function d(c, d) {
                if (
                    (c.data("title") || c.data("title", c.attr("title")),
                    !c.data("title"))
                )
                    return !1;
                b.$tooltip || f(),
                ...
                b.$tooltip.css("position", ""),
                    ...
                    "static" != a(b.o_doc).find("body").css("position")
                        ? (b.$tooltip.css(
                              "margin-left",
                              -a(b.o_doc).find("body").offset().left
                          ),
                          b.$tooltip.css(
                              "margin-top",
                              -a(b.o_doc).find("body").offset().top
                          ))
            ...
            function f() {
                b.opts.tooltips &&
                    ...
                    (b.shared.$tooltip
                        ...
                        : ((b.shared.$tooltip = a(
                              '<div class="fr-tooltip"></div>'
                          )),
                          (b.$tooltip = b.shared.$tooltip),
                          b.opts.theme &&
                              b.$tooltip.addClass(b.opts.theme + "-theme"),
                          a(b.o_doc).find("body").append(b.$tooltip)),
                    b.events.on(
                        "shared.destroy",
                        function () {
        ...
        (a.FE.MODULES.button = function (b) {
            function c(b, c, d) {
                for (var e = a(), f = 0; f < b.length; f++) {
                    var g = a(b[f]);
                    if (
                        (g.is(c) && (e = e.add(g)), d && g.is(".fr-dropdown"))
                    ) {
                        var h = g.next().find(c);
                        e = e.add(h);
                    }
            ...
            function e(c) {
                var e = c.next(),
                    ...
                    h =
                        c.parents(".fr-toolbar, .fr-popup").data("instance") ||
                        b;
                if (
                    (h.helpers.isIOS() &&
                    ...
                    e
                        ...
                        a.FE.COMMANDS[i] &&
                            ...
                            a.FE.COMMANDS[i].refreshOnShow.apply(h, [c, e]),
                        e.css(
                            "left",
                            c.offset().left -
                ...
                c.addClass("fr-blink").toggleClass("fr-active"),
                    ...
                    e.offset().left + e.outerWidth() >
                        b.$sc.offset().left + b.$sc.outerWidth() &&
                        e.css(
                            "margin-left",
                            -(
                                e.offset().left +
                ...
                j.length
                    ? b.accessibility.focusToolbarElement(j)
                    : b.accessibility.focusToolbarElement(c);
            }
            function f(a) {
                a.addClass("fr-blink"),
                    setTimeout(function () {
                ...
                for (
                    var b = a.data("cmd"), c = [];
                    "undefined" != typeof a.data("param" + (c.length + 1));
                ...
                if (
                    ...
                    for (var f = 0; f < a.FE.INSTANCES.length; f++)
                        a.FE.INSTANCES[f] != d &&
                            ...
                            a.FE.INSTANCES[f].$el.find(".fr-marker").remove();
                    d.popups.hideAll();
                }
                b.node.hasClass(c.get(0), "fr-dropdown")
                    ? e(c)
                    : (g(c),
                      a.FE.COMMANDS[c.data("cmd")] &&
                          a.FE.COMMANDS[c.data("cmd")].refreshAfterCallback !==
                              !1 &&
            ...
            function m(c, d) {
                ...
                var e = c.get(0).ownerDocument,
                    ...
                    g = function (d) {
                        (!d ||
                            (d.type == b._mouseup &&
                                d.target != a("html").get(0)) ||
                            ("keydown" == d.type &&
                                ((b.keys.isCharacter(d.which) &&
                                    !b.keys.ctrlKey(d)) ||
                ...
                b.events.$on(a(f), b._mouseup + " resize keydown", g, !0),
                    ...
                    b.node.hasClass(c.get(0), "fr-popup")
                        ? a.merge(w, c.find(".fr-btn").toArray())
                        : a.merge(v, c.find(".fr-btn").toArray()),
            ...
            function o(a, c, d) {
                ...
                if ("dropdown" == c.type) {
                    var m =
                        '<div class="fr-dropdown-menu" role="listbox" aria-labelledby="' +
                        k +
            ...
            function p(c, d) {
                for (var e = "", f = 0; f < c.length; f++) {
                    ...
                    if (
                        ...
                        if (h) {
                            var i =
                                "undefined" == typeof d || d.indexOf(g) >= 0;
                            e += o(g, h, i);
                        } else
                            "|" == g
                                ? (e +=
            ...
            function q(c) {
                var d,
                    e =
                        c.parents(".fr-popup, .fr-toolbar").data("instance") ||
                        b,
                    f = c.data("cmd");
                b.node.hasClass(c.get(0), "fr-dropdown")
                    ? (d = c.next())
            ...
            function r(c) {
                ...
                return (
                    b.events.trigger("buttons.refresh") === !1 ||
                    void setTimeout(function () {
                        for (
                            var e = d.selection.inEditor() && d.core.hasFocus(),
                                f = 0;
                            f < c.length;
                            f++
                        ) {
                                ...
                                ? e ||
                                  (a.FE.COMMANDS[h] &&
                                    ...
                                    : b.node.hasClass(
                                      ...
                                      g.attr("aria-pressed") &&
                                          g.attr("aria-pressed", !1))
                                : g.parents(".fr-popup").is(":visible") &&
                                  d.button.refresh(g);
                        }
                    }, 0)
                );
            ...
            function u() {
                b.opts.toolbarInline
                    ? b.events.on("toolbar.show", s)
                    : (b.events.on("mouseup", s),
                      b.events.on("keyup", s),
                      b.events.on("blur", s),
                      b.events.on("focus", s),
                      b.events.on("contentChanged", s)),
                    b.events.on("shared.destroy", t);
            }
            var v = [];
            (b.opts.toolbarInline || b.opts.toolbarContainer) &&
                (b.shared.buttons || (b.shared.buttons = []),
                (v = b.shared.buttons));
            var w = [];
            return (
                b.shared.popup_buttons || (b.shared.popup_buttons = []),
                (w = b.shared.popup_buttons),
                {
                    _init: u,
                    buildList: p,
                    bindCommands: m,
        ...
        (a.FE.MODULES.modals = function (b) {
            ...
            function d(c, d) {
                ...
                return (
                    (e += '<div class="fr-modal-head">' + c + f + "</div>"),
                    (e +=
                        '<div tabIndex="-1" class="fr-modal-body">' +
                        d +
                        "</div>"),
                    (e += "</div></div>"),
                    a(e)
                            ...
                            function (d) {
                                ...
                                return e == a.FE.KEYCODE.ESC
                                    ? (h(c),
                                      ...
                                      !1)
                                    : !(
                                          !a(d.currentTarget).is(
                                              "input[type=text], textarea"
                                          ) &&
                                          e != a.FE.KEYCODE.ARROW_UP &&
                                          e != a.FE.KEYCODE.ARROW_DOWN &&
                                          !b.keys.isBrowserAction(d)
                                      ) ||
                                          (d.preventDefault(),
                                          d.stopPropagation(),
                                          !1);
            ...
            function g(a) {
                if (n[a]) {
                    ...
                    c.data("instance", b),
                        ...
                        b.helpers.isMobile() &&
                            b.$doc.find("body").addClass("fr-mobile"),
                        c.addClass("fr-active"),
                        b.accessibility.focusModal(c);
                }
            }
            function h(a, c) {
                if (n[a]) {
                    ...
                    e.events.enableBlur(),
                        ...
                        c ||
                            (b.accessibility.restoreSelection(e),
        ...
        (a.FE.MODULES.popups = function (b) {
            function c(a, c) {
                c.is(":visible") || (c = b.$sc),
                    c.is(x[a].data("container")) ||
                        (x[a].data("container", c), c.append(x[a]));
            }
            function d(a, d, e, h) {
                if (
                    (g() && b.$el.find(".fr-marker").length > 0
                        ? (b.events.disableBlur(), b.selection.restore())
                        : (b.events.disableBlur(),
                          b.events.focus(),
                          b.events.enableBlur()),
                ...
                b.opts.toolbarInline &&
                    ...
                    (e =
                        b.$tb.offset().top -
                        b.helpers.getPX(b.$tb.css("margin-top"))),
                    (d =
                        b.$tb.offset().left +
                        b.$tb.outerWidth() / 2 +
                        (parseFloat(
                            b.$tb.find(".fr-arrow").css("margin-left")
                        ) || 0) +
                    ...
                    !b.opts.iframe ||
                        h ||
                        k ||
                        (d && (d -= b.$iframe.offset().left),
                        e && (e -= b.$iframe.offset().top)),
                    l.is(b.$tb)
                        ? b.$tb.css("zIndex", (b.opts.zIndex || 1) + 4)
                        : x[a].css("zIndex", (b.opts.zIndex || 1) + 4),
                    d && (d -= j / 2),
                    b.opts.toolbarBottom &&
                        l &&
                        b.$tb &&
                        l.get(0) == b.$tb.get(0) &&
                        (x[a].addClass("fr-above"),
                        e && (e -= x[a].outerHeight())),
            ...
            function f(a) {
                return (
                    (x[a] &&
                        b.node.hasClass(x[a], "fr-active") &&
                        b.core.sameInstance(x[a])) ||
                    !1
                );
            }
            function g(a) {
                    ...
                    _preventFocus: function (c) {
                        ...
                        var f = c.originalEvent
                            ? c.originalEvent.target ||
                              c.originalEvent.originalTarget
                            : null;
                        "mouseup" == c.type ||
                            a(f).is(":focus") ||
                            e.events.disableBlur(),
                                ...
                                return (
                                    ...
                                    f.popups.isVisible(c) &&
                                        (d.find(".fr-back:visible").length
                                            ? (f.button.exec(
                                                  d.find(
                                                      ".fr-back:visible:first"
                                                  )
                                              ),
                                              f.accessibility.focusPopupButton(
                                                  d
                                              ))
                                            : d.find(".fr-dismiss:visible")
                                                  .length
                                            ? f.button.exec(
                                                  d.find(
                                                      ".fr-dismiss:visible:first"
        ...
        (a.FE.MODULES.position = function (b) {
            function c() {
                ...
                if (
                    ...
                    e.css("display", "none"),
                        ...
                        (c.top =
                            f.top -
                            (b.helpers.isMobile() ? 0 : b.helpers.scrollTop())),
                        (c.right = 1),
                        (c.bottom = 1),
                        (c.ok = !0),
                        d && b.selection.restore();
            ...
            function d(a, c, d) {
                ...
                if (
                    ...
                    a.parent().offset().top + g > 0
                        ? ((c = g), a.addClass("fr-above"))
            ...
            function e(a, c) {
                ...
                return (
                    c + d > b.$sc.get(0).clientWidth - 10 &&
                        (c = b.$sc.get(0).clientWidth - d - 10),
                    c < 0 && (c = 10),
                    c
                );
            }
            ...
            function g(a, c, f, g) {
                ...
                !h ||
                    ...
                    c && (c -= h.offset().top),
                    "BODY" != h.get(0).tagName
                        ? (a && (a += h.get(0).scrollLeft),
                          c && (c += h.get(0).scrollTop))
                ...
                if (a) {
                    ...
                    j || ((j = f.find(".fr-arrow")), f.data("fr-arrow", j)),
                        j.data("margin-left") ||
                            j.data(
                                "margin-left",
                                b.helpers.getPX(j.css("margin-left"))
                            ),
                        ...
                        d.data(
                            ...
                            setTimeout(function () {
                                var a = b.helpers.scrollTop(),
                                    c = Math.min(
                                        Math.max(
                                            a - b.$tb.parent().offset().top,
                                            0
                                        ),
                                        b.$tb.parent().outerHeight() -
                                            d.outerHeight()
                                    );
                                c > 0 &&
                                    "BODY" == b.$tb.parent().get(0).tagName &&
                                    (c += b.$tb.parent().position().top),
                                    c != f &&
                                        (d.css("top", Math.max(c, 0)),
                                        d.data("sticky-top", c),
                ...
                if (c.offsetWidth) {
                    ...
                    var l =
                            "body" == b.opts.scrollableContainer
                                ...
                                : j,
                        m = f.is(".fr-sticky-on");
                    f.data("sticky-parent") ||
                        f.data("sticky-parent", f.parent());
                    ...
                    if (
                        ...
                        q || f.css("position", "fixed"),
                            ...
                            f.data(
                                "top",
                                b.node.hasClass(f.get(0), "fr-top")
                                    ? f.css("top")
                                    : "auto"
                            ),
                            f.data(
                                "bottom",
                                b.node.hasClass(f.get(0), "fr-bottom")
                                    ? f.css("bottom")
                                    : "auto"
                            );
                    }
            ...
            function d() {
                ...
                (c =
                    "INPUT" === b.$el.prop("tagName")
                        ...
                        : b.$el.text()),
                    d.find("input").val(c).trigger("change"),
        ...
        (a.FE.MODULES.toolbar = function (b) {
            ...
            function i() {
                ...
                return (
                    !!a.next().find(b.o_doc.activeElement).length ||
                    void (
                        b.events.trigger("toolbar.hide") !== !1 && b.$tb.hide()
                    )
                );
            }
            function j() {
                return (
                    b.events.trigger("toolbar.show") !== !1 && void b.$tb.show()
                );
            }
            function k(c) {
                clearTimeout(w),
            ...
            function l() {
                b.events.on("window.mousedown", i),
                    ...
                    b.helpers.isMobile() &&
                        (b.events.$on(b.$doc, "selectionchange", k),
                        ...
                        function (a) {
                            var c = a.originalEvent
                                ? a.originalEvent.target ||
                                  a.originalEvent.originalTarget
                                : null;
                            if (
                                c &&
                                "INPUT" != c.tagName &&
            ...
            function q() {
                return (
                    (b.$sc = a(b.opts.scrollableContainer)),
                    !!b.$wp &&
                        (b.opts.toolbarContainer
                            ? (b.shared.$tb
                                  ? ((b.$tb = b.shared.$tb),
                                    b.opts.toolbarInline && l())
                                  : ((b.shared.$tb = a(
                                        '<div class="fr-toolbar"></div>'
                                    )),
                                    (b.$tb = b.shared.$tb),
